...
PIWIK_API_URL = "http://pc01.prismacode.net/piwik/piwik.php";

//The url of the custom server-side caching script
PIWIK_CACHER_URL = "http://pc01.prismacode.net/gm_piwikdemo/addcachedrequests.php";
